...
export class GreetStreamRequest extends Message<GreetStreamRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "greet.v1.GreetStreamRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
export class GreetStreamResponse extends Message<GreetStreamResponse> {
  /**
   * @generated from field: string people = 1;
   */
  people = "";
  ...
  static readonly runtime = proto3;
  static readonly typeName = "greet.v1.GreetStreamResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "people", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
