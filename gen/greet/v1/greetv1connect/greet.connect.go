...
import (
	context "context"
	errors "errors"
	v1 "github.com/alexanderjophus/streamingRPC/gen/greet/v1"
...
func NewGreetServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) GreetServiceClient {
	...
	return &greetServiceClient{
		...
		greetStream: connect_go.NewClient[v1.GreetStreamRequest, v1.GreetStreamResponse](
			httpClient,
...
// GreetStream calls greet.v1.GreetService.GreetStream.
func (c *greetServiceClient) GreetStream(ctx context.Context, req *connect_go.Request[v1.GreetStreamRequest]) (*connect_go.ServerStreamForClient[v1.GreetStreamResponse], error) {
...
func NewGreetServiceHandler(svc GreetServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/greet.v1.GreetService/GreetStream", connect_go.NewServerStreamHandler(
